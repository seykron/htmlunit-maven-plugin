...
public abstract class NanoHTTPD {
    ...
    public static class Response {
        ...
        public static void error(final OutputStream outputStream, final Status error, final String message) {
         ...
         */
        private void send(final OutputStream outputStream) {
        ...
        public enum Status {
            ...
            Status(final int requestStatus, final String descr) {
    ...
    protected class HTTPSession implements Runnable {
         ...
         */
        private void decodeHeader(final BufferedReader in, final Map<String, String> pre, final Map<String, String> parms, final Map<String, String> header)
        ...
        private void decodeMultipartData(final String boundary, final ByteBuffer fbuf, final BufferedReader in, final Map<String, String> parms,
                                         final Map<String, String> files) throws InterruptedException {
            try {
        ...
        private String saveTmpFile(final ByteBuffer  b, final int offset, final int len) {
            ...
            if (len > 0) {
                ...
                try {
                    ...
                    dest = new FileOutputStream(tempFile.getName()).getChannel();
         ...
         */
        private void decodeParms(final String parms, final Map<String, String> p) throws InterruptedException {
            if (parms == null) {
